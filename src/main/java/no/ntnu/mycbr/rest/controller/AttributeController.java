...
public class AttributeController {
    ...
    @Operation(summary = GET_ATTRIBUTE_BY_ID, operationId = GET_ATTRIBUTE_BY_ID)
    ...
    @Operation(summary = GET_ATTRIBUTE_DESCRIPTION, operationId = GET_ATTRIBUTE_DESCRIPTION)
    ...
    //get All attributes
    @Operation(summary = GET_ALL_ATTRIBUTES, operationId = GET_ALL_ATTRIBUTES)
    ...
    //add one attribute
    @Operation(summary = ADD_ATTRIBUTE_BY_ID, operationId = ADD_ATTRIBUTE_BY_ID)
    ...
    /*
    @Operation(summary = COPY_ATTRIBUTE_BY_ID, operationId = COPY_ATTRIBUTE_BY_ID) // copy
...
//,
  //  @PathVariable(value=NEW_ATTR_ID) String newAttributeID)
    ...
    @Operation(summary = DELETE_ATTRIBUTE_BY_ID, operationId = DELETE_ATTRIBUTE_BY_ID)
    ...
    @Operation(summary = DELETE_ALL_ATTRIBUTES, operationId = DELETE_ALL_ATTRIBUTES)
    ...
    @Operation(summary = GET_ACTIVE_SIMILARITY_FUNCTION, operationId = GET_ACTIVE_SIMILARITY_FUNCTION)
    ...
    @Operation(summary = GET_ALL_ATTRIBUTE_SIMILARITY_FUNCTIONS, operationId = GET_ALL_ATTRIBUTE_SIMILARITY_FUNCTIONS)
    ...
    @Operation(summary = DELETE_ALL_ATTRIBUTE_SIMILARITY_FUNCTIONS, operationId = DELETE_ALL_ATTRIBUTE_SIMILARITY_FUNCTIONS)
    ...
    @Operation(summary = ADD_ATTRIBUTE_SIMILARITY_FUNCTION, operationId = ADD_ATTRIBUTE_SIMILARITY_FUNCTION)

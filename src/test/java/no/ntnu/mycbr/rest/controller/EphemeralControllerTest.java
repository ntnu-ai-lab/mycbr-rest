...
public class EphemeralControllerTest implements RetrievalCustomer{
    ...
    private final static String TEST_RESOURCES_PATH = PATH_SEPARATOR + "src" + PATH_SEPARATOR + "test" + PATH_SEPARATOR + "resources" + PATH_SEPARATOR;
    ...
    private  final static String URL_PATH = "/ephemeral"
	    	+ "/concepts/" + TEST_CONCEPT_ID
	    	+ "/casebases/" + TEST_CASEBASE_ID
	    	+ "/amalgamationFunctions/" + TEST_AMAL_FUNC_ID
	    	+ "/retrievalByCaseIDs?k=-1";
    
    private final static String TEST_API_POST_BODY_10_CASES = "{ "
	    + "\"query_case_id_list\": [ "
    ...
    private final static String TEST_API_POST_BODY_50_CASES = "{ "
	    + "\"query_case_id_list\": [ "
	    + "\"car0\", \"car2\", \"car3\", \"car4\", \"car5\", \"car6\", \"car7\", \"car8\", \"car9\","
    ...
    private final static String TEST_API_POST_BODY_100_CASES = "{ "
	    + "\"query_case_id_list\": [ "
	    + "\"car0\", \"car2\", \"car3\", \"car4\", \"car5\", \"car6\", \"car7\", \"car8\", \"car9\","
	    + "\"car10\", \"car12\", \"car13\", \"car14\", \"car15\", \"car16\", \"car17\", \"car18\", \"car19\","
	    + "\"car20\", \"car22\", \"car23\", \"car24\", \"car25\", \"car26\", \"car27\", \"car28\", \"car29\","
    ...
    public void retrievalFromEphemeralCaseBaseTest() throws Exception {
        ...
        final MockHttpServletRequestBuilder servlet = post(URL_PATH)
        	.content(TEST_API_POST_BODY_10_CASES)
       ...
       System.out.println("End of the retrievalFromEphemeralCaseBaseTest() !\n\n");
    } 
    
    
    @Test
    /**
     * This test causes exceptions, at no.ntnu.mycbr.core.model.Concept.setActiveAmalgamFct(Concept.java:817),
     * while setting the user defined amalgamation function from the set of available amalgamation functions.
     * The exception was observed for the variable (threadCount) value to be 100, on macbook pc.
     * @throws Exception
     */
